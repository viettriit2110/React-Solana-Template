...
exports.PhantomWalletAdapter = exports.PhantomWalletName = void 0;
const wallet_adapter_base_1 = require("@solana/wallet-adapter-base");
const web3_js_1 = require("@solana/web3.js");
exports.PhantomWalletName = 'Phantom';
class PhantomWalletAdapter extends wallet_adapter_base_1.BaseMessageSignerWalletAdapter {
    constructor(config = {}) {
        super();
        this.name = exports.PhantomWalletName;
        ...
        if (this._readyState !== wallet_adapter_base_1.WalletReadyState.Unsupported) {
            (0, wallet_adapter_base_1.scopePollingDetectionStrategy)(() => {
                var _a, _b, _c;
                if (((_b = (_a = window.phantom) === null || _a === void 0 ? void 0 : _a.solana) === null || _b === void 0 ? void 0 : _b.isPhantom) || ((_c = window.solana) === null || _c === void 0 ? void 0 : _c.isPhantom)) {
    ...
    connect() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const wallet = ((_a = window.phantom) === null || _a === void 0 ? void 0 : _a.solana) || window.solana;
